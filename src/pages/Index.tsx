...
const PROJECTS: Project[] = [
  {
    id: 'cac-segmentation', title: 'CAC Segmentation · ML4Sci GSoC 2026', label: 'Deep Learning', tagColor: 'tag-purple', year: '2026', badge: 'GSoC 2026', badgeColor: 'tag-blue',
    short: 'Building and comparing segmentation strategies for Coronary Artery Calcium using U-Net on the Stanford COCA dataset.',
    detail: 'Midterm Jul 10 · Final Aug 24',
    tech: ['PyTorch', 'U-Net', 'Medical Imaging'],
    github: 'https://github.com/sohamjadhav95/ML4Sci-DeepLense-GSoC2026',
    metrics: [{ label: 'Median Dice', value: '0.9416' }, { label: 'Speedup', value: '3,157×' }]
  },
  {
    ...
    detail: 'Published in Cureus (Springer Nature). Pre-delivery validation across Text + Image + Audio in <3s. 100K synthetic training samples for LLM fine-tuning.',
    tech: ['Gemma 3', 'BLIP-2', 'Whisper', 'Policy-as-Prompt'],
  ...
  {
    id: 'renaissance', title: 'RenAIssance OCR', label: 'Computer Vision', tagColor: 'tag-amber', year: '2026', badge: 'HumanAI', badgeColor: 'tag-blue',
    short: 'Historical Spanish CRNN using ResNet-18 + BiLSTM + CTC.',
    detail: 'HumanAI GSoC 2026 proposal. Complete pipeline for optical character recognition on historical manuscripts.',
    tech: ['PyTorch', 'ResNet-18', 'BiLSTM', 'CTC']
  },
  {
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'start' }}>
              <div>
                ...
                <div className="reveal" style={{ background: 'var(--off)', borderRadius: '10px', padding: '1.25rem 1.5rem', fontFamily: 'DM Mono', fontSize: '0.8rem', lineHeight: 1.8, transitionDelay: '0.22s' }}>
                  ...
                  <span style={{ color: 'var(--ink)' }}>"Ship AI that
                    works."</span>
                </div>
              </div>
              <div>
